  ...
  return (
    <section id='Projects' className='Projects'>
      ...
      <div className="project-container">
        ...
        <Projectcard imgSrc={img2} alt={"Checkout Page preview"} projectTitle={"Checkout Page"} projectDescription={"A"} builtwith={"React - SCSS"} repositorylink={"https://github.com/varJonathanR/checkout-page.git"} demolink={"https://checkout-page-varjonathanr.netlify.app/"} />
        <Projectcard imgSrc={img3} alt={"Edie Homepage preview"} projectTitle={"Edie Homepage"} projectDescription={"A"} builtwith={"React - SCSS"} repositorylink={"https://github.com/varJonathanR/edie-homepage.git"} demolink={"https://edie-homepage-varjonathanr.netlify.app/"} />
      </div>
      <hr />
    </section>
  )
